...
import static cn.kanejin.webop.Constants.BACK_URL;
import static cn.kanejin.webop.Constants.ERROR_MSG;
import static cn.kanejin.webop.Constants.MESSAGE;
import static cn.kanejin.webop.Constants.OP_JUMP_PARAMS;
import static cn.kanejin.webop.Constants.PATH_VAR;
import static cn.kanejin.webop.Constants.TOKEN;
import static cn.kanejin.webop.Constants.UPLOADED;
...
public class OperationContextImpl implements OperationContext {
	...
	public boolean isMultipart() {
		...
		return (Boolean)req.getAttribute(UPLOADED);
	}
	...
	public FileItem getFileItem(String fileItemKey) {
		...
		MultipartFormdataRequest mreq = (MultipartFormdataRequest) req;
